...
(function() {
  ...
  DomUtilities = {
    ...
    simulateSelect: function(element) {
      if (element === document.activeElement && DomUtilities.isEditable(document.activeElement)) {
    ...
    flashRect: function(rect) {
      ...
      return setTimeout((function() {
        return DomUtilities.removeElement(flashEl);
      }), 400);
    },
    ...
    suppressKeyupAfterEscape: function(handlerStack) {
      return handlerStack.push({
        ...
        keyup: function(event) {
          if (!KeyboardUtilities.isEscape(event)) {
            return true;
          }
          this.remove();
          return false;
